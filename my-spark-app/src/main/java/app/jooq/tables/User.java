...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -1473818788;
    ...
    /**
     * The column <code>library.user.username</code>.
     */
